...
import utils.one_hot_encoding as ohe
...
class mydataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        label = ohe.encode(image_name.split('_')[
...
def get_test_onek_data_loader():
    dataset = mydataset(captcha_setting.TEST_ONEK_DATASET_PATH, transform=transform)
    return DataLoader(dataset, batch_size=1, shuffle=True)
